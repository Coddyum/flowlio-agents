...
// |--------------------|-----------------------------------------------------------|-------|
// | Handler            | Adaptateur HTTP de la feature issue                         | 35    |
// | New                | Crée le handler issue                                       | 40    |
// | Handler.writeJSON  | Sérialise la réponse avant d'engager le statut               | 48    |
// | Handler.writeError | Répond une erreur domaine, sans fuite d'interne             | 76    |
// | Handler.decodeBody | Décode un corps JSON en refusant les champs inconnus        | 91    |
// | Handler.scope      | Extrait la paire team + projet du token de la requête       | 102   |
// | Handler.ref        | Lit la référence CORE-34 depuis le chemin                   | 117   |
